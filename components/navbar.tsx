...
export const Navbar = () => {
  ...
  return (
    <NextUINavbar maxWidth="xl" position="sticky" className="navbar-glass shadow-lg" shouldHideOnScroll>
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-1" href="/">
            <Logo />
            <p className="font-bold text-inherit">Apel Manis</p>
          </NextLink>
        </NavbarBrand>
      ...
      <NavbarContent className="hidden sm:flex basis-1/5 sm:basis-full" justify="end">
        <NavbarItem className="hidden sm:flex gap-2">
          <SettingsSwitcher onLocaleChange={setLocale} currentLocale={locale} />
        </NavbarItem>
      </NavbarContent>
